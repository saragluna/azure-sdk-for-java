...
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.CLIENT_ID;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.CLIENT_SECRET;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.LOGOUT_SUCCESS_URL;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.REPLY_URL;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.SIGN_UP_OR_SIGN_IN;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TENANT;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TEST_CLIENT_ID;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TEST_CLIENT_SECRET;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TEST_LOGOUT_SUCCESS_URL;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TEST_REPLY_URL;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TEST_SIGN_UP_OR_IN_NAME;
import static com.microsoft.azure.spring.autoconfigure.btoc.AADB2CConstants.TEST_TENANT;
